...
## Now
- MCP — wrap existing tools as an MCP server, agent becomes MCP client. Then resources (KB docs) + prompts (canned support prompts). Biggest curriculum gap (9 boxes), highest resume value, named in target JD.
